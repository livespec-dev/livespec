...
Define how LiveSpec extracts tracked checklist items, supports selection and copy workflows, and reports whole-document progress with incomplete-only filtering.
