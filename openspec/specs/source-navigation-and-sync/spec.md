...
Define how LiveSpec navigates back to source markdown, refreshes from `TextDocument` changes, synchronizes multiple open editors, and restores lightweight semantic state.
