...
Define repository-level LiveSpec configuration, including how `.livespec/config.json` is loaded, validated, and used to determine effective spec-file matching behavior.
